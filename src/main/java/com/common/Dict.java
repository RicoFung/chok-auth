...
public class Dict 
{
	...
	/**
	 * 获取权限树节点集合
	 * @param authorityId 已关联权限id
	 * @param params
	 * @return List<Object>
	 */
	public static List<Object> getAuthorityTreeNodes(Long authorityId, Map<String, Object> params)
	{
		return getTreeNodes(authorityId, params, Factory.getAuthorityService());
	}
