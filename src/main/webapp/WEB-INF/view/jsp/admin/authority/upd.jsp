			...
			<div class="box-body">
				<form class="dataForm" id="dataForm" role="form" action="upd2" method="post">
					...
					<div class="form-group"><label class="control-label" for="pid">父节点：</label>
						<input type="text" class="form-control input-sm" id="sel_authority" value="${po.m.tc_p_name}[${po.m.pid}]"/>
...
var authoritySetting = {
	...
	{
		enable: true,
		url:function(){return "${ctx}/dict/getAuthorityTreeNodes?authorityId=${po.m.pid}&tc_app_id="+$("#tc_app_id").val();}
	}
};
/**********************************************************/
/* 全局函数 */
