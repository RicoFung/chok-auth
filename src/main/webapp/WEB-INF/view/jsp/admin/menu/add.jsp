			...
			<div class="box-body">
				<form class="dataForm" id="dataForm" role="form" action="add2" method="post">
					...
					<div class="form-group"><label class="control-label" for="tc_authority_id">权限：</label>
						<input type="text" class="form-control input-sm" id="sel_authority"/>
						<input type="hidden" class="form-control input-sm" id="tc_authority_id" name="m['tc_authority_id']" />
					</div>
...
var appSetting = {
	...
	{
		enable: true,
		url:function(){return "${ctx}/dict/getAppTreeNodes";}
	}
};
//menuTree 的参数配置
var menuSetting = {
	...
	{
		enable: true,
		url:function(){return "${ctx}/dict/getMenuTreeNodes?tc_app_id="+$("#tc_app_id").val();}
	} 
};
// authorityTree 的参数配置
var authoritySetting = {
	...
	{
		enable: true,
		url:function(){return "${ctx}/dict/getAuthorityTreeNodes?tc_type=1&tc_app_id="+$("#tc_app_id").val();}
	}
};
/**********************************************************/
/* 全局函数 */
