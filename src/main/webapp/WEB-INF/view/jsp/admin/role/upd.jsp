					...
					<div class="row">
						<div class="col-md-6 column">
							...
							<legend>基础信息</legend>
								...
								<input type="hidden" id="tc_authority_ids" name="m['tc_authority_ids']" value="${po.m.tc_authority_ids}">
							</fieldset>
						</div>
						<div class="col-md-6 column">
							<fieldset>
							<legend>权限</legend>
								...
								<ul id="authorityTree" class="ztree" style="overflow:auto"></ul>
							</fieldset>
						</div>
					</div>
				</form>
...
$(function(){
    ...
    $("#chkAll").click(function(){
    	...
    	$("#tc_authority_ids").val(getCheckedNodesIds());
    });
});
/**********************************************************/
/* zTree配置 */
...
var setting = 
{
	...
	{
		enable: true,
		url:"getAuthorityTreeNodesByRoleId?tc_role_id=${po.m.id}"
	},
	data: 
	{
		key: 
