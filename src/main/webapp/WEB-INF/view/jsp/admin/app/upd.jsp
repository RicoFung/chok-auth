		...
		<div class="box box-default">
			...
			<div class="box-body">
				<form class="dataForm" id="dataForm" role="form" action="upd2" method="post">
					...
					<div class="form-group"><label class="control-label" for="tc_authority_id">权限：</label><input type="text" class="form-control input-sm" id="tc_authority_id" name="m['tc_authority_id']" value="${po.m.tc_authority_id}"/></div>
...
var authoritySetting = {
	...
	{
		enable: true,
		url:"${ctx}/dict/getAuthorityTreeNodes?tc_type=0&authorityId=${po.m.tc_authority_id}"
	}
};
/**********************************************************/
/* 全局函数 */
...
$(function(){
	...
	// 定义权限树选择框
    var s1 = $("#modal_sel1").ZtreeSelectModal({treeid:"tree_authority",
												  title:"请选择权限节点",
	...
	$("#tc_authority_id").focus(function(){
		s1.modal("show");
	});
});
</script>