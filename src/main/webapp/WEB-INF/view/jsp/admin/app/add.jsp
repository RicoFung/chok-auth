		...
		<div class="box box-default">
			...
			<div class="box-body">
				<form class="dataForm" id="dataForm" role="form" action="add2" method="post">
					...
					<div class="form-group"><label class="control-label" for="tc_authority_id">权限：</label><input type="text" class="form-control input-sm" id="tc_authority_id" name="m['tc_authority_id']" /></div>
...
var authoritySetting = {
	...
	{
		enable: true,
		url:"${ctx}/dict/getAuthorityTreeNodes?tc_type=0"
	}
};
/**********************************************************/
/* 全局函数 */
